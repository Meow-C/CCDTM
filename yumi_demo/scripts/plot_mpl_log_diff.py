...
def sub_data_all(msg):
    ...
    # data_all = msg.data
    data_all[4] = math.log(data_all[4],10)
...
if __name__ == '__main__':
    ...
    ln_5, = ax.plot([], [], '-', color = '#0072BD', label = 'log(diff,10)', animated=False)
