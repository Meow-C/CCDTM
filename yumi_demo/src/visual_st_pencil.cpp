...
std::string WRITE_TARGET_DIR = "/home/monica/Desktop/LOG_INFO/yumi_demo_data/visual_st_effector";
std::string MOTION_RESOURCES_DIR = "/home/monica/Desktop/LOG_INFO/motion_record";
std::string MOTION_NAME = "motion10";
...
std::string SPHERETREE_NAME = "finger-medial-depth3-branch8-unbiased.sph";
...
void WriteTMdis() {
    std::string TMfile = WRITE_TARGET_DIR + "/" + MOTION_NAME + "/" + "TMdis.txt";
