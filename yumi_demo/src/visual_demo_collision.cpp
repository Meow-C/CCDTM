...
bool collisioncallback(cInterval &T, result &collisionresult) {
    ...
    if (only_time)
    {
        outfile = WRITE_TARGET_DIR + "/" + MOTION_NAME + "/" + "time_fclbvh.txt";
        outfile2 = WRITE_TARGET_DIR + "/" + MOTION_NAME + "/" + "num_fclbvh.txt";
    }
    else
        outfile = WRITE_TARGET_DIR + "/" + MOTION_NAME + "/" + "timeandnum_fclbvh.txt";
